-- =====================================================
-- DATA IMPORT - Șoferi, Camioane, Remorci
...
BEGIN
    ...
    -- ȘOFERI (25 șoferi)
    -- =====================================================
    INSERT INTO drivers (company_id, first_name, last_name, phone, id_card_number, employee_type, status)
    VALUES (v_company_id, 'Sorin', 'Stavila', '+40745125616', 'ZS 125790', 'sofer', 'activ')
    ON CONFLICT DO NOTHING;

    INSERT INTO drivers (company_id, first_name, last_name, phone, id_card_number, employee_type, status)
    VALUES (v_company_id, 'Zoltan', 'Csaki', '+40740995253', 'ZS 209609', 'sofer', 'activ')
    ON CONFLICT DO NOTHING;

    INSERT INTO drivers (company_id, first_name, last_name, phone, id_card_number, employee_type, status)
    VALUES (v_company_id, 'Sergiu', 'Negru', '+40755917056', 'ZS 211351', 'sofer', 'activ')
    ON CONFLICT DO NOTHING;

    INSERT INTO drivers (company_id, first_name, last_name, phone, id_card_number, employee_type, status)
    VALUES (v_company_id, 'Bogdan', 'Iancu', '+40746563527', 'M1006785', 'sofer', 'activ')
    ON CONFLICT DO NOTHING;

    INSERT INTO drivers (company_id, first_name, last_name, phone, id_card_number, employee_type, status)
    VALUES (v_company_id, 'Marian', 'Cordos', '+40765479015', 'ZS 089094', 'sofer', 'activ')
    ON CONFLICT DO NOTHING;

    INSERT INTO drivers (company_id, first_name, last_name, phone, id_card_number, employee_type, status)
    VALUES (v_company_id, 'Istvan', 'Kiss', '+40757182494', 'ZS 298147', 'sofer', 'activ')
    ON CONFLICT DO NOTHING;

    INSERT INTO drivers (company_id, first_name, last_name, phone, id_card_number, employee_type, status)
    VALUES (v_company_id, 'Sorin', 'Chilut', '+40749792009', 'ZS 213157', 'sofer', 'activ')
    ON CONFLICT DO NOTHING;

    INSERT INTO drivers (company_id, first_name, last_name, phone, id_card_number, employee_type, status)
    VALUES (v_company_id, 'Cristin', 'Kardos', '+40745380705', 'MS 888292', 'sofer', 'activ')
    ON CONFLICT DO NOTHING;

    INSERT INTO drivers (company_id, first_name, last_name, phone, id_card_number, employee_type, status)
    VALUES (v_company_id, 'Daniel', 'Macarie', '+40740616241', 'ZS 220149', 'sofer', 'activ')
    ON CONFLICT DO NOTHING;

    INSERT INTO drivers (company_id, first_name, last_name, phone, id_card_number, employee_type, status)
    VALUES (v_company_id, 'Levente', 'Mathe Sandor', '+40791201815', 'ZS 339965', 'sofer', 'activ')
    ON CONFLICT DO NOTHING;

    INSERT INTO drivers (company_id, first_name, last_name, phone, id_card_number, employee_type, status)
    VALUES (v_company_id, 'Ioan', 'Bondor', '+40756793101', 'ZS 032786', 'sofer', 'activ')
    ON CONFLICT DO NOTHING;

    INSERT INTO drivers (company_id, first_name, last_name, phone, id_card_number, employee_type, status)
    VALUES (v_company_id, 'Horea', 'Teban', '+40757795284', 'ZS 173276', 'sofer', 'activ')
    ON CONFLICT DO NOTHING;

    INSERT INTO drivers (company_id, first_name, last_name, phone, id_card_number, employee_type, status)
    VALUES (v_company_id, 'Andrei', 'Ursan', '+40756862431', 'CJ 245092', 'sofer', 'activ')
    ON CONFLICT DO NOTHING;

    INSERT INTO drivers (company_id, first_name, last_name, phone, id_card_number, employee_type, status)
    VALUES (v_company_id, 'Szilard', 'Portik', '+40740754302', 'MS 915504', 'sofer', 'activ')
    ON CONFLICT DO NOTHING;

    INSERT INTO drivers (company_id, first_name, last_name, phone, id_card_number, employee_type, status)
    VALUES (v_company_id, 'Istvan', 'Czitrom', '+40752526768', 'ZS 247738', 'sofer', 'activ')
    ON CONFLICT DO NOTHING;

    INSERT INTO drivers (company_id, first_name, last_name, phone, id_card_number, employee_type, status)
    VALUES (v_company_id, 'Paul', 'Moldovan', '+40740756940', 'ZS 056348', 'sofer', 'activ')
    ON CONFLICT DO NOTHING;

    INSERT INTO drivers (company_id, first_name, last_name, phone, id_card_number, employee_type, status)
    VALUES (v_company_id, 'Mugurel', 'Mihalachi', '+40770837436', 'ZS 096247', 'sofer', 'activ')
    ON CONFLICT DO NOTHING;

    INSERT INTO drivers (company_id, first_name, last_name, phone, id_card_number, employee_type, status)
    VALUES (v_company_id, 'Vasile', 'Farcas', '+40740082244', 'ZS 185078', 'sofer', 'activ')
    ON CONFLICT DO NOTHING;

    INSERT INTO drivers (company_id, first_name, last_name, phone, id_card_number, employee_type, status)
    VALUES (v_company_id, 'Sandor', 'Mathe', '+40745678011', 'ZS 172875', 'sofer', 'activ')
    ON CONFLICT DO NOTHING;

    INSERT INTO drivers (company_id, first_name, last_name, phone, id_card_number, employee_type, status)
    VALUES (v_company_id, 'Codrutu', 'Fabian', '+40742011625', 'N/A', 'sofer', 'activ')
    ON CONFLICT DO NOTHING;

    INSERT INTO drivers (company_id, first_name, last_name, phone, id_card_number, employee_type, status)
    VALUES (v_company_id, 'Csaba', 'Szasz', '+40743959159', 'ZS 126147', 'sofer', 'activ')
    ON CONFLICT DO NOTHING;

    INSERT INTO drivers (company_id, first_name, last_name, phone, id_card_number, employee_type, status)
    VALUES (v_company_id, 'Valeriu', 'Nicusan', '+40731338676', 'ZS 334618', 'sofer', 'activ')
    ON CONFLICT DO NOTHING;

    INSERT INTO drivers (company_id, first_name, last_name, phone, id_card_number, employee_type, status)
    VALUES (v_company_id, 'Petru', 'Moldovan', '+40745617345', 'ZS 186773', 'sofer', 'activ')
    ON CONFLICT DO NOTHING;

    INSERT INTO drivers (company_id, first_name, last_name, phone, id_card_number, employee_type, status)
    VALUES (v_company_id, 'Zsolt', 'Timar', '+40748566714', 'MS 975251', 'sofer', 'activ')
    ON CONFLICT DO NOTHING;

    INSERT INTO drivers (company_id, first_name, last_name, phone, id_card_number, employee_type, status)
    VALUES (v_company_id, 'Romeo', 'Costinas', '+40755591932', 'ZS 155004', 'sofer', 'activ')
    ON CONFLICT DO NOTHING;
